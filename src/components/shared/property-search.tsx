    ...
    <section className='py-10 lg:pt-25'>
      <ContainerWrapper>
        <div className='flex flex-col items-center gap-15 px-5'>
          <div className='flex flex-col gap-5 md:max-w-4/5 md:max-w-202'>
            <Typography as='h1'>Find Your Dream Property</Typography>
            <Typography
              as='p'
              styleVariant='muted'
            >
          ...
          <div className='flex w-full flex-col items-center gap-15 lg:flex-row'>
            ...
            <Button
              asChild
              className='w-full lg:size-9 lg:w-auto'
            >
              <Link
